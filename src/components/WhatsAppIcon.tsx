 ...
 * Lambang WhatsApp.
 *
 * Digambar sendiri sebagai path SVG, bukan diambil dari pustaka ikon, supaya
 * tidak ada satu pun paket tambahan yang ikut terkirim hanya demi satu bentuk.
 * Warnanya mengikuti `currentColor`.
 *
 * Selalu `aria-hidden` — tombol yang memakainya sudah punya teks sendiri, jadi
 * kalau ikon ini ikut dibacakan, pembaca layar akan menyebut dua kali.
 */
